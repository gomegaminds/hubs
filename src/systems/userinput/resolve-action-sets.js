...
export function resolveActionSets() {
    ...
    userinput.toggleSet(sets.leftCursorHoveringOnGizmo, hc(world, Gizmo, leftRemoteHovering));
    userinput.toggleSet(sets.rightCursorHoveringOnGizmo, hc(world, Gizmo, rightRemoteHovering));
    userinput.toggleSet(sets.leftCursorHoldingGizmo, hc(world, Gizmo, leftRemoteHolding));
    userinput.toggleSet(sets.rightCursorHoldingGizmo, hc(world, Gizmo, rightRemoteHolding));
