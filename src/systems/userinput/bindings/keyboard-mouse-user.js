...
const startEditingViaMouse = "/vars/mouse-and-keyboard/startEditingViaMouse";
const startEditingViaKeyboard = "/vars/mouse-and-keyboard/startEditingViaKeyboard";
...
export const keyboardMouseUserBindings = addSetsToBindings({
    ...
    [sets.rightCursorHoveringOnInteractable]: [
        ...
        },
        {
            ...
            dest: {
                click: paths.actions.cursor.right.click,
                grab: paths.actions.cursor.right.grab,
                drop: paths.actions.cursor.right.drop
            },
            xform: xforms.clickOrGrab(300),
            priority: 1
        },
        {
            src: { value: paths.device.mouse.buttonRight },
