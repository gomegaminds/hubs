...
import { Waypoint, NetworkedWaypoint } from "../bit-components";
            ...
            if (
                ...
                const onHover = () => {
                    ...
                    if (
                        ...
                        !this.waypointForTemplateEl[id].data.willMaintainInitialOrientation
                    ) {
...
AFRAME.registerComponent("waypoint", {
    ...
    remove() {
        if (!this.didRegisterWithSystem) {
            ...
            removeComponent(APP.world, Waypoint, this.el.object3D.eid);
        }
    }
});
