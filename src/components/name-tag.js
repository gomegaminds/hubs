...
AFRAME.registerComponent("name-tag", {
    ...
    updateTheme() {
        this.nametagStatusBorder.el.setAttribute("slice9", "color", this.isHandRaised ? "#FFCD74" : "#7ED320");
        nametagVolumeMaterial.color.set("#7ED320");
        this.nametagBackground.el.setAttribute("slice9", "color", "#000000");
        this.nametagText.el.setAttribute("text", "color", "#FFFFFF");
    },
