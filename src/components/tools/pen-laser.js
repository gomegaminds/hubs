...
AFRAME.registerComponent("pen-laser", {
    schema: {
        ...
        laserOrigin: { default: { x: 0, y: 0, z: 0 }, type: "vec3" },
        remoteLaserOrigin: { default: { x: 0, y: 0, z: 0 }, type: "vec3" },
        laserTarget: { default: { x: 0, y: 0, z: 0 }, type: "vec3" }
    },
    ...
    update: (() => {
        ...
        return function (prevData) {
            ...
            if (
                prevData.remoteLaserOrigin &&
                !almostEquals(0.001, prevData.remoteLaserOrigin, this.data.remoteLaserOrigin)
            ) {
