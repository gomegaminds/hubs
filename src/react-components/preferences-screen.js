...
export class NumberRangeSelector extends Component {
    ...
    componentDidMount() {
        ...
        this.setState({
            displayValue: this.props.store.state.preferences[this.props.storeKey].toFixed(this.props.digits),
        });
    }
                ...
                <div className={classNames(styles.numberInNumberWithRange)}>
                    <input
                        ...
                        onBlur={(e) => {
                            ...
                            const numberOrReset = isNaN(parseFloat(sanitizedInput))
                                ? undefined
                                : parseFloat(sanitizedInput);
                            this.setState({
                                displayValue:
                                    numberOrReset === undefined
                                        ? this.props.store.state.preferences[this.props.storeKey].toFixed(
                                              this.props.digits
                                          )
                                        : Math.min(Math.max(this.props.min, numberOrReset), this.props.max).toFixed(
                                              this.props.digits
                                          ),
                                isFocused: false,
                            });
...
class PreferenceListItem extends Component {
    ...
    render() {
        ...
        const disabled =
            (this.props.itemProps.disableIfTrue &&
                this.props.store.state.preferences[this.props.itemProps.disableIfTrue]) ||
            (this.props.itemProps.disableIfFalse &&
                !this.props.store.state.preferences[this.props.itemProps.disableIfFalse]);
                    ...
                    {TOP_LEVEL_CATEGORIES.map((category) => (
                        <NavItem
                            ...
                            ariaLabel={intl.formatMessage(
                                {
                                    id: "preferences-screen.select-category ",
                                    defaultMessage: "Select category {categoryName}",
                                },
                                {
